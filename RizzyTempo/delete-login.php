    ...
    <body>
        ...
        if (isset($_POST['btnDelete'])) {
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<h1>Delete Login Detail</h1>";
                echo "<form action='' method='POST'>";
                echo "<table>";
                echo "<tr><td>User Name:</td><td>" . $row->username . "</td></tr>";
                echo "<tr><td>Email:</td><td>" . $row->email . "</td></tr>";
                echo "<tr><td>Gender:</td><td>" . $row->gender . "</td></tr>";
                echo "<tr><td>Password:</td><td>" . $row->userPw . "</td></tr>";
                echo "<input type='hidden' name='hdID' value='" . $row->username . "'>";
                echo "</table>";

                // Add a confirmation step
                echo "<div class='confirmation'>Are you sure you want to delete this record?</div>";
                echo "<div class='flex'>";
                echo "<input type='submit' name='btnDelete' value='Delete' class='button' onclick='return confirm(\"Are you sure you want to delete this record?\")'>";
                echo "<input type='button' value='Cancel' name='btnCancel' class='button' onclick='location = \"list-login.php\"'>";
                echo "</div>";
                echo "</form>";
