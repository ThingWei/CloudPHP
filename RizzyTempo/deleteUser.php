...
<html>
    ...
    <body>
        ...
        if ($_SERVER["REQUEST_METHOD"] == 'GET') {
            ...
            $sql = "DELETE FROM $lowercasetable WHERE username = ?";
            ...
            if ($stmt->affected_rows > 0) {
                //record deleted
                //urlencode used to replace special char like space-_ into +% 
                echo '<script>alert("User REMOVED from this event.");document.location="eventsJoined.php?eventName=' . urlencode($eventname) . '";</script>';
            }
            $stmt->close();
            $con->close();
        }
        ...
        <div class="container mt-5 pt-5">
            <div class="row">
                <div class="col-12 col-sn-8 col-nd-6 m-auto">
                    <div class="card">
                        <h2 class="d-flex justify-content-center" style="padding-top: 20px;">Delete Participant From Event
                        </h2>
                        <hr>
                        <div class="card-body">
                            <form action="" method="post">
                                ...
                                <input style="margin-bottom: 1rem !important;" type="text" name="username"
                                       class="form-control py-2" value="<?php echo isset($username) ? $username : ""; ?>" disabled>
