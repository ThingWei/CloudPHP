...
<body>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active mx-lg-2" style="color:white;" href="eventsAdmin.php">Events</a>
                            </li>
                            <li class="nav-item">
    ...
    <?php
        ...
        <a href="createEvent.php"><button class="createbtn">Create Event</button></a> &nbsp;&nbsp;
        <a href="deleteEvent.php"><button class="createbtn">Delete Event</button></a>
        </div>';
            ...
            <a href="eventsJoined.php?eventName=%s">Check Participants</a></div></div></td>',
                        $row->eventBanner,
                        $row->eventName,
                        $row->headline,
                        $row->eventName
