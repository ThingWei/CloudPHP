...
<html>
    ...
    <body>
        ...
        <h1>Update User Acc Information</h1>
        <?php
        require_once 'helper.php';
...
//                $hashedPassword = password_hash($password, PASSWORD_BCRYPT);
                ...
                $query = "UPDATE user SET username='$name' WHERE email='$email'";
            ...
            <div class="container">
                <form action="" method="POST">
                    <table>
                        ...
                        <tr>
                            <th>Email:</th>
                            <td><input type="email" name="email" class="input-field" value="<?php echo isset($email) ? $email : ""; ?>"disabled/></td>
                        </tr>
                    ...
                    <input type="button" value="Cancel" name="btnCancel" class="input-button" onclick="location = 'list-login.php'"/>
                </form>
            </div>
        </div>
        <p>&nbsp;</p>
