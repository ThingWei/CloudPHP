...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Update User Payment Details</title>
    ...
    <body>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active mx-lg-2" style='color:white;' href="list-payment.php">Payment List</a>
                            </li>
                            <li class="nav-item">
        ...
        <h1>Update User Payment Details</h1>
        <?php
        require_once 'helper.php';
...
// Check if the user has clicked the modify button
        if (isset($_POST['btnModify'])) {
            ...
            $stmt = $db->prepare("SELECT COUNT(*) FROM payment WHERE email = ?");
        ...
        <div class="container">
            <form action="" method="POST">
                ...
                <br/>
                <div class="button">
                    <input type="submit" value="Update" class="input-button" name="btnModify" />
